// ─────────────────────────────────────────────────────────────────────────────
// 通用子框架内核（@elysia-ai/kernel re-export）
// 管线编排 / 请求上下文 / 类型化事件 / 生命周期 / manifest 治理 / trace / harness。
// 需要脱离 AI 领域复用这些原语的消费者可直接依赖 @elysia-ai/kernel。
// ─────────────────────────────────────────────────────────────────────────────
export * from '@elysia-ai/kernel'

// ─────────────────────────────────────────────────────────────────────────────
// 领域管线定义（阶段表 / 分段执行集合 / 上下文载体 / 服务名单一事实来源）
// ─────────────────────────────────────────────────────────────────────────────
